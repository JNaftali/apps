...
export class PublicAvataxExciseConnectionService {
  private readonly connectionService: AvataxExciseConnectionService;
  ...
  constructor({
    ...
    this.connectionService = new AvataxExciseConnectionService({ client, appId, saleorApiUrl });
